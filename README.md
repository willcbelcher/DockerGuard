...
- **[Docker Security Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Docker_Security_Cheat_Sheet.html)** — *OWASP*  
  _Short note on what concept it influenced._

- **[docker security best practices from the dockerfile](https://cloudberry.engineering/article/dockerfile-security-best-practices/)** — *Gianluca Brindisi*  
  _Short note on what concept it influenced._

- **[Dockerfile Security Best Practices: How to Build Secure Containers](https://medium.com/@IamLucif3r/dockerfile-security-best-practices-how-to-build-secure-containers-a4fc25c4f2be)** — *Anmol Singh Yadav*  
